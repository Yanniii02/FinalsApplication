...
class RailsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create rail" do
    assert_difference("Rail.count") do
      post rails_url, params: { rail: { Reservation: @rail.Reservation, passenger_id: @rail.passenger_id, trip_id: @rail.trip_id } }
    end
  ...
  test "should update rail" do
    patch rail_url(@rail), params: { rail: { Reservation: @rail.Reservation, passenger_id: @rail.passenger_id, trip_id: @rail.trip_id } }
